...
INSERT INTO "user" (login, password, first_name, last_name, email, phone, is_active, user_detail_id) VALUES ('admin', '123456', 'walter', 'white', 'admin@lux.com','+7-900-800-70-60', true, 1);
INSERT INTO "user" (login, password, first_name, last_name, email, phone, is_active, user_detail_id) VALUES ('user', '123456', 'jesse', 'pinkman','user@lux.com','88006005530', true, 2);
...
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('INVICTA', false, 1099.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 0);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('AUDEMARS PIGUET', false, 1195.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 0);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('CITIZEN', false, 3575.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 10);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('GLYCINE', false, 318.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 15);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('AUDEMARS PIGUET', true, 199.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 5);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('SEVENFRIDAY', true, 1895.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 2);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('BAUME ET MERCIER', false, 1495.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 0);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('BAUME ET MERCIER', true, 1540.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 0);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('SEVENFRIDAY', false, 1895.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 50);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('AUDEMARS PIGUET', true, 318.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 10);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('GLYCINE', false, 3575.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 0);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('CITIZEN',  false, 1195.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 10);
INSERT INTO "product" (title, is_hit, price, text, discount) VALUES ('AUDEMARS PIGUET', true, 1099.00, 'BAUME ET MERCIER Baume and Mercier Hampton Silver Dial Brown Leather Ladies Watch', 8);
